              ...
              <div className="relative group">
                ...
                <div className="relative bg-white rounded-2xl p-8 shadow-xl border border-gray-200 hover:border-purple-200 transition-all duration-300 group-hover:-translate-y-1">
                  <div className="mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-3">View All Database Tables</h3>
                    <p className="text-gray-600 leading-relaxed">
                      Browse every row from the inspection schema tables in one place
                    </p>
                  </div>
                  <button
